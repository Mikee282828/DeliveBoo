                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('register') }}" enctype="multipart/form-data">
                            ...
                            <div class="mb-4 row">
                                <label for="restaurant_tax_id" class="col-md-4 col-form-label text-md-right">{{ __('Restaurant TAX ID') }}*</label>
                                <div class="col-md-6">
                            ...
                            <div class="mb-4">
                                @foreach ($categories as $item)
                                    <div class="form-check">
                                        <input type="checkbox" id="category_{{ $item->id }}" class="form-check-input" name="category_id[]" value="{{ $item->id }}">
                            ...
                            <div class="mb-3">
                                <label for="img" class="form-label mt-3">{{ __('Select Image') }}</label>
